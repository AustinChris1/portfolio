    ...
    ?>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    {
                                        $user_id = $_GET['id'];
                                        $editquery = $db->query("SELECT * FROM spectradb WHERE id='$user_id'");
                                ...
                                <form action="editcode.php" method="POST">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <option value="" <?= $user['usertype'] == '' ? 'selected':''?>>User</option>
                                            <option value="super" <?= $user['usertype'] == 'super' ? 'selected':''?>>Super Admin</option>

    ...
    ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    $category_id = $_GET['id'];
                                    $categoryedit = $db->query("SELECT * FROM categories WHERE id='$category_id' LIMIT 1");
                                ...
                                <form action="editcode.php" method="POST">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <label for="">Meta Description</label>
                                            <textarea name="meta_description" max="191" required class="form-control"  rows="4"><?=$row['meta_description']?></textarea>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Meta Keyword</label>
                                            <textarea name="meta_keyword" max="191" required class="form-control"  rows="4"><?=$row['meta_keyword']?></textarea>
                                        </div>
                                        <div class="col-md-6 mb-3">
